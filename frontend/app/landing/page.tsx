...
// Parallax animated dot grid — moves slower than page content for a depth effect
function ParallaxDotGrid() {
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundPositionY: `${scrollY * 0.18}px`,
      }}
    />
  );
}
